  ...
  return (
    <div>
      ...
      >
        ...
        />
        <h1 style={{ color: "#eb347d", textAlign: "center" }}>
          {capitilizer(pokemonName)}
        </h1>
      </div>
        ...
        <div>
          <div style={{ marginRight: 20 }}>
            ...
            <div>
              ...
              <ProcessBar
                width={"250px"}
                value={pokemonSpecies && pokemonSpecies.base_happiness}
              />
            </div>
            <div>
              ...
              <ProcessBar
                width={"250px"}
                value={pokemonSpecies && pokemonSpecies.capture_rate}
              />
            </div>
            <div>
            ...
            <div>
              <p>
                Growth Rate: {pokemonSpecies && pokemonSpecies.growth_rate.name}
              </p>
            </div>
            <div>
            ...
            <div>
              <p>
                Is Baby:{" "}
                {pokemonSpecies && pokemonSpecies.is_baby ? "Yes" : "No"}
              </p>
            </div>
            <div>
              <p>
                Is Legendary:{" "}
                {pokemonSpecies && pokemonSpecies.is_legendary ? "Yes" : "No"}
              </p>
            </div>
            <div>
              <p>
                Is Mythical:{" "}
                {pokemonSpecies && pokemonSpecies.is_mythical ? "Yes" : "No"}
              </p>
            </div>
            <div>
              <p>Shape: {pokemonSpecies && pokemonSpecies.shape.name}</p>
            </div>
          </div>
        </div>
      </div>
